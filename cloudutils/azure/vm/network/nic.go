...
// vnetname given, subnetname default, security group: seems like each have their own security group
// ipName: need to create one, nicname: based on vm name
// dns: InterfaceDNSSettings
func CreateNIC(ctx context.Context, vmName, vnetName,
	subnetName, nsgName, ipName, nicName string) (nic network.Interface, err error) {
